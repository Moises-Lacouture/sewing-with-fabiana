...
export const patterns = [
  ...
  {
    // PLACEHOLDER — swap name/subtitle/teaser for the real pattern, or delete
    // this entry. Add the remaining fields and flip status to 'available' when
    // it goes on sale.
    slug: 'next-pattern',
    status: 'coming-soon',
    name: 'Next pattern',
    subtitle: 'In the works — the second of the Rectangle Series.',
    teaser: 'Coming soon',
  },
];

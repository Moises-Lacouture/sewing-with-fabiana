    ...
    questions: [
      {
        ...
        a: "All patterns are delivered as PDF files in A4, US Letter, and A0 formats. They include the pattern pieces, step-by-step sewing instructions with sketches, and a comprehensive YouTube tutorial.",
      },
      {
    ...
    questions: [
      {
        ...
        a: "Our patterns are recommended for advanced beginners. Each one includes detailed step-by-step instructions with sketches, and every pattern has a dedicated YouTube tutorial to walk you through the entire process.",
      },
      {
        q: "Do you have video tutorials?",
        a: "Yes — every pattern has its own comprehensive YouTube tutorial that walks you through the entire sewing process step by step.",
      },
      {
...
export const checkoutUrls = {
  alessandra: "https://sewingwithfabiana.lemonsqueezy.com/checkout/buy/b65b9d87-3be3-4534-bd35-2be3d1dace7c",
};

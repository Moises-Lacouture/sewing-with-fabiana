...
export const patterns = [
  ...
  {
    // A teaser only — no product page, no sitemap entry, nothing to buy.
    // When the pattern is ready: rename it, add the fields Alessandra has
    // above, and flip status to 'available'.
    // `mark` is what sits in the tile; it defaults to the name's first letter,
    // which only says something once the pattern has a real name.
    slug: 'coming-soon',
    status: 'coming-soon',
    name: 'A new pattern',
    subtitle: 'In the works — follow along to hear it first.',
    teaser: 'Coming soon',
    mark: '…',
  },
];
